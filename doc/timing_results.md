...
| Library      | Primitive       | Failing tests        | Timing difference |
| ------------ | --------------- | -------------------- |-------------------|
| bip-schnorr  | Schnorr         | msb, lsb, bit_length | 200 $\mu s$       |
...
| spongycastle | Ecdsa secp256k1 | msg, lsb, bit_length |  <2 $\mu s$       |
...
| Library      | Primitive         | Samples           | Bias | Status              |
| ------------ | ---------------   | ----------------  | ---- |---------------------|
| bip-schnorr  | Schnorr secp256k1 | 3'907 / 500'000   | 0.32 | (underlying lib)    |
...
| sjcl         | Ecdsa secp256r1   |                   | 0.99 | [known since 2017](https://github.com/bitwiseshiftleft/sjcl/issues/438) |
...
| pycryptodome | Ed25519           | 2'533 / 5'000'000 | 0.99 | reported (June 2025) |
...
Maintainer claims, that I have not been using browserify-sign for the tests.
